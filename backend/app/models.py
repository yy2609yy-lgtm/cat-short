...
class IgnoredSource(Base):
    """source_key values skipped by Drive/inbox sync after a workbench delete.

    Drive remains the remote source of truth; this only prevents the next sync
    from immediately recreating a job the admin just removed.
    """
